	...
	function mfn_ID( $param = false )
	{
		...
		if (function_exists('is_woocommerce') && is_woocommerce() ) {
			...
			if( is_product() ){
				...
				if( get_post_meta( get_the_ID(), 'mfn_single_product_template', true ) && get_post_status( get_post_meta( get_the_ID(), 'mfn_single_product_template', true ) ) == 'publish' ){
					return get_post_meta( get_the_ID(), 'mfn_single_product_template', true ); // single product template
				}

				if( get_post_meta(get_the_ID(), 'mfn_product_cat_template') && get_post_status( get_post_meta( get_the_ID(), 'mfn_product_cat_template', true ) ) == 'publish' ){
					return get_post_meta(get_the_ID(), 'mfn_product_cat_template', true); // all categories product template
				}

				if( get_post_meta(get_the_ID(), 'mfn_product_tag_template') && get_post_status( get_post_meta( get_the_ID(), 'mfn_product_tag_template', true ) ) == 'publish' ) {
					return get_post_meta(get_the_ID(), 'mfn_product_tag_template', true); // all tags product template
				}

				if( get_post_meta(get_the_ID(), 'mfn_product_template') && get_post_status( get_post_meta( get_the_ID(), 'mfn_product_template', true ) ) == 'publish' ){
					return get_post_meta(get_the_ID(), 'mfn_product_template', true); // shop product template
				}
				...
				if( !empty(get_post_meta(wc_get_page_id('shop'), 'mfn_shop_template')) && get_post_status( get_post_meta(wc_get_page_id('shop'), 'mfn_shop_template', true) ) == 'publish' ){
